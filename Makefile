...
# Suppress some warnings on imported code as they're extremely
# noisy and detract from the warnings we desire to see:
#
${ZLIBOBJS}: CFLAGS+=-Wno-deprecated-non-prototype -Wno-strict-prototypes
